...
public class AppScanningService extends IntentService
{
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        RealmResults<App> previousApps = realm.where(App.class).findAll();
        ...
        for(ApplicationInfo applicationInfo : applications)
        {
            ...
            App app = realm.where(App.class).equalTo("packageName", applicationInfo.packageName).findFirst();
        ...
        {
            App uninstalledApp = realm.where(App.class).equalTo("packageName", uninstalledAppPackage).findFirst();
